...
public class warehouseToCarousel extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        double rotationsNeeded = 21.5/CIRCUMFERENCE;
        int encoderDrivingTarget = (int) (rotationsNeeded*robot.THREEONETWO_MOTOR_TICK_COUNT*2*6);
